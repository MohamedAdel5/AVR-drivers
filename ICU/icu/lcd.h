...
/*CONTROL PORT CONFIG*/
#define LCD_CTRL_PORT PORTD			/*Defines the port of the control register*/
#define LCD_CTRL_PORT_DIR DDRD		/*Defines the direction register of the control port*/
#define RS	PD4					/*Register select (HIGH: transfer display data, LOW:transfer instruction data)*/
#define RW	PD5						/*Read/Write select(HIGH:read, LOW:write)*/
#define E	PD7						/*Enable (HIGH:enable data, LOW: disable data)*/
...
void LCD_displayInteger(uint32 data);									/*Displays a given integer*/
